...
5. Incluye una sección llamada “Principios de los modelos utilizados”, donde expliques brevemente los fundamentos de cada modelo seleccionado por el usuario.
6. Si se seleccionan varios modelos de regresión, compara su capacidad predictiva, errores de pronóstico, interpretabilidad y limitaciones.
7. No afirmes causalidad si los resultados no la soportan.
8. Señala limitaciones metodológicas cuando existan.
9. Interpreta con prudencia pruebas de normalidad, raíz unitaria, ACF, PACF, residuales y métricas de modelo.
10. No inventes resultados, variables, cifras ni conclusiones.
11. Interpreta explícitamente el modo de pronóstico seleccionado por el usuario. Si el modo fue evaluación de capacidad predictiva, analiza los errores y el desempeño fuera de muestra. Si el modo fue pronóstico de valores no observados, aclara que se trata de estimaciones sin error observable y que requieren validación posterior.
{instruccion_contexto}
{instruccion_respuestas}
...
5. Principios de los modelos utilizados
6. Principales hallazgos
7. Interpretación integrada
8. Limitaciones
9. Recomendaciones
10. Respuestas clave, solo si el usuario formuló preguntas
11. Conclusión
