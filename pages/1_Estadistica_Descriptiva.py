...
descripcion_variables = capturar_descripcion_variables(variables, "estadistica_descriptiva")
...
if st.session_state["resultados_descriptiva_actuales"] is not None:
    ...
    desc_df = descripcion_variables_df(resultados_actuales.get("descripcion_variables", {}))
    ...
    with c4:
        ...
        pdf_bytes = crear_pdf_modulo(
            ...
            resultados_actuales,
            tablas=[("Descripción de variables", desc_df), ("Estadísticos principales", tabla_est), ("Percentiles", tabla_pct), ("Pruebas estadísticas", tabla_pruebas), ("ACF", tabla_acf), ("PACF", tabla_pacf)],
            figuras=figuras_pdf,
