...
alg = st.sidebar.selectbox("Algoritmo", ["Árbol de decisión", "Random Forest", "Gradient Boosting", "Support Vector Regression"])
...
escalar = st.sidebar.checkbox("Estandarizar variables X", value=alg in ["Support Vector Regression"])
